...
I will also post my original samples and a copy of the code and i will add a version with comments so it is more redable (though i am not good at adding comments, i think the code is self explanatory though i will try).
